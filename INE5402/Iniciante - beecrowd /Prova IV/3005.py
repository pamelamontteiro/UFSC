def verificar_pilha(paralelepido_um, paralelepipedo_dois):
    ...
    if (
        paralelepipedo_dois[2] > paralelepido_um[1]
        and paralelepipedo_dois[1] > paralelepido_um[0]
    ) and (
        paralelepido_um[2] > paralelepipedo_dois[1]
        and paralelepido_um[1] > paralelepipedo_dois[0]
    ):
        return 3
