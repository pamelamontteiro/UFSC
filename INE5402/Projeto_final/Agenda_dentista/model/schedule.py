...
class Schedule:
    ...
    def set_schedule(
        self, day, start_time, end_time, dentist_start_time, dentist_end_time, client
    ):
        is_schedule_valid = self.validate_schedule_time(
            start_time, end_time, dentist_start_time, dentist_end_time
        )
    ...
    def validate_schedule_time(
        self, start_time, end_time, dentist_start_time, dentist_end_time
    ):
        if (
            start_time < end_time
            and start_time >= dentist_start_time
            and end_time <= dentist_end_time
        ):
            return True
        return False
