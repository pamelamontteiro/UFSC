...
class AddDentist:
    ...
    def create_inputs(self):
        ...
        self.canvas.create_image(700.0, 250.0, image=input_cro)
        ...
        self.entry_cro.place(x=576.0, y=233.0, width=246.0, height=34.0)
        ...
        self.canvas.create_image(700.0, 300.0, image=input_starting_hour)
        ...
        self.entry_starting_hour.place(x=576.0, y=283.0, width=246.0, height=34.0)
        ...
        self.canvas.create_image(700.0, 350.0, image=input_ending_hour)
        ...
        self.entry_ending_hour.place(x=576.0, y=333.0, width=246.0, height=34.0)
    ...
    def create_buttons(self):
        ...
        add_btn = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: self.add_dentist(
                self.name.get(),
                self.cro.get(),
                self.start_hour.get(),
                self.end_hour.get(),
